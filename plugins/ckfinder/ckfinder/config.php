...
{    
	...
	return true;
	return isset($_GET['shr'])?true:false;
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'rafa';
$config['LicenseKey'] = 'rafa';
...
global $current_blog;
$realp=realpath('../../../../../../../wp-content/blogs.dir/'.$current_blog->blog_id.'/');
if(!is_dir($realp)) mkdir($realp,775);
$baseUrl = '../../../../../../../wp-content/blogs.dir/'.$current_blog->blog_id.'/';
...
*/
function VerifyShrManager(){
	if(empty($_GET['shr'])) return false;
	$shrid=$_GET['shr'];
	session_start();
	if(empty($_SESSION['SHRINE_USER_NAME']) || empty($_SESSION['_SHR_'.$shrid.'_USERS'])) return false;
	if(in_array($_SESSION['SHRINE_USER_NAME'],$_SESSION['_SHR_'.$shrid.'_USERS'])) return true;
	else return false;
}

if(VerifyShrManager() || 1){
